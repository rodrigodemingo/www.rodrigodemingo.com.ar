...
<form action="#" method="post" enctype="multipart/form-data" name="settings_form" id="settings_form">
  <tr>
    <td width="50%"><h2><?php _e('General Settings', 'wp-optimize'); ?></h2></td>
    <td><h2><?php _e('Auto Clean-up Settings', 'wp-optimize'); $wpo_auto_options = get_option('wp-optimize-auto');?></h2></td>
  </tr>
  <tr>
   ...
   <br />
   <small><?php 
            _e('This option will retain the last X weeks data and remove any garbage data before that period', 'wp-optimize'); 
 			?>
			</small>
   <br />
   <br />
...
-->
  ...
  <tr>
    <td><input class="button-primary" type="submit" name="wp-optimize-settings1" value="<?php _e('SAVE SETTINGS', 'wp-optimize'); ?>" /></td>
    <td><input class="button-primary" type="submit" name="wp-optimize-settings" value="<?php _e('SAVE AUTO CLEAN-UP SETTINGS', 'wp-optimize'); ?>" /></td>
  </tr>  
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
