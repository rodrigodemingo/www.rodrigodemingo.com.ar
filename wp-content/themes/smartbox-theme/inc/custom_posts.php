...
$labels = array(
    'name'               => _x( 'Timeline', THEME_ADMIN_TD ),
    'singular_name'      => _x( 'Timeline', THEME_ADMIN_TD ),
    'add_new'            => _x( 'Add New', THEME_ADMIN_TD ),
...
$labels = array(
    'name'               => _x('Portfolio Items', THEME_ADMIN_TD),
    'singular_name'      => _x('Portfolio Item', THEME_ADMIN_TD),
    'add_new'            => _x('Add New', THEME_ADMIN_TD),
