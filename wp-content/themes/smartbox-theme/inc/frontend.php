...
function oxy_page_header() {
    global $post;
    switch( get_post_meta( $post->ID, THEME_SHORT . '_header_type', true ) ) {
        case 'none':
        break;
        case 'slideshow':
            ?>
            <section class="section section-alt">
                <div class="row-fluid">
                    <?php
                    $slideshow_slug = get_post_meta( $post->ID, THEME_SHORT . '_slideshow', true );
        ...
        case 'super_hero':
            ...
            $title = get_post_meta( $post->ID, THEME_SHORT . '_header_title', true ) == '' ? get_the_title():get_post_meta( $post->ID, THEME_SHORT . '_header_title', true );
