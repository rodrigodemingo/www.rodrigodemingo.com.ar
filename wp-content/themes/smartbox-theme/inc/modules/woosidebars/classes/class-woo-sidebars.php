...
class Woo_Sidebars {
	...
	public function __construct ( $file ) {
		...
		$this->plugin_url = MODULES_URI  . 'woosidebars'; //str_replace( '/classes', '', plugins_url( plugin_basename( dirname( __FILE__ ) ) ) );
	...
	public function register_post_type () {
		...
		$labels = array(
			...
			'add_new' => _x( 'Add New', 'Widget Area', 'woosidebars' ),
